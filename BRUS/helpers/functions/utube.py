...
async def yt_search(BRUS):
    try:
        BRUS = urllib.parse.quote(BRUS)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={BRUS}"
        )
...
"""
async def yt_data(BRUS):
    params = {"format": "json", "url": BRUS}
