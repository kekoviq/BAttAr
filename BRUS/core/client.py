        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    kekoviq.add_event_handler(func, events.MessageEdited(**kwargs))
                kekoviq.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                kekoviq.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                kekoviq.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
