...
import requests
import json
from BRUS.helpers.functions.functions import translate
...
@kekoviq.ar_cmd(pattern="(الترجمة الفورية|الترجمه الفوريه|ايقاف الترجمة|ايقاف الترجمه)")
...
@kekoviq.ar_cmd(pattern="لغة الترجمة")
