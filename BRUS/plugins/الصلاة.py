...
from . import kekoviq, edit_delete, edit_or_reply
...
async def get_adzan(adzan):
    ...
    kekoviqresult = f"<b>اوقـات صـلاه المـسلمين 👳‍♂️ </b>\
    ...
    "
    await edit_or_reply(adzan, kekoviqresult, "html")

# Copyright (C) 2021 BRUS TEAM
# FILES WRITTEN BY  @IS0S0I