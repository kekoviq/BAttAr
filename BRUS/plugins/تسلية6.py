...
@kekoviq.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular BRUS",
    },
)
...
@kekoviq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular BRUS",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@kekoviq.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna BRUS is One of the Popular BRUS",
    },
)
async def nekobot(cat):
...
@kekoviq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; BRUS is One of the Popular BRUS",
    },
)
async def nekobot(cat):
