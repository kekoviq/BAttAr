...
from . import kekoviq, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m BRUS`",
        "**State changed from starting to up**",
        "__INFO:BRUS:Logged in as 557667062__",
        "__INFO:BRUS:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
