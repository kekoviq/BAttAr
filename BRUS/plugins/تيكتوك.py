...
async def tiktok_dl(event):
    ...
    if event:
            if ("https://tiktok.com/" in ms or "https://vm.tiktok.com/" in ms):
                ...
                a = await kekoviq.send_message(event.chat_id, 'يجري البحث عن الملف..')
                link = ms.strip()
                try:
                    ...
                    return await a.edit(f"حدث خطأ قم بتوجيه الرسالة الى مطوري @IS0S0I\n{er}")
